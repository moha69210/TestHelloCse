    ...
    <script>
        ...
        !function (a, b) {
            ...
            var Gb = /#.*$/, Hb = /([?&])_=[^&]*/, Ib = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
                ...
                Mb = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Nb = {}, Ob = {},
                Pb = "*/".concat("*"), Qb = Cb.href, Rb = Mb.exec(Qb.toLowerCase()) || [];
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a style="font-weight: bold" class="navbar-brand" href="{{ url('/') }}">HelloCse</a>
            </div>
            <div class="collapse navbar-collapse" id="navbar-collapse-target">
                <ul class="nav navbar-nav ">
                    <li><a href="{{url('/')}}" data-toggle="collapse" data-target=".navbar-collapse.in">Affichage</a>
                    </li>
                    <li><a href="{{url('/listerFicheStar')}}" data-toggle="collapse" data-target=".navbar-collapse.in">BackOffice</a>
                    </li>
                </ul>
            </div>
        </div>
